      ...
      <div className="dets font-['Neue_Montreal']">
        <div>
            ...
            <div className='leading-[1.5rem]'>
                <a href="./Footer.jsx" className='underline'>Instagram</a><br/>
                <a href="./Footer.jsx" className='underline'>Behance</a><br/>
                <a href="./Footer.jsx" className='underline'>Facebbok</a><br/>
                <a href="./Footer.jsx" className='underline'>Linkedin</a>
            </div>
        </div>
        <div className='flex gap-96 pt-10'>
            <div>
                <p className='pb-6'>L:</p>
                <a href="./Footer.jsx" className='underline'>
                202-1965 W 4th Ave<br/>Vancouver, Canada<br/><br/>30 Chukarina St<br/>Lviv, Ukraine
                </a>
            </div>
            <div>
                <p className='pb-6'>M:</p>
                <div className='leading-[1.5rem]'>
                <a href="./Footer.jsx" className='underline'>Home</a><br/>
                <a href="./Footer.jsx" className='underline'>Services</a><br/>
                <a href="./Footer.jsx" className='underline'>Our work</a><br/>
                <a href="./Footer.jsx" className='underline'>About us</a><br/>
                <a href="./Footer.jsx" className='underline'>Insights</a><br/>
                <a href="./Footer.jsx" className='underline'>Contact us</a>
            </div>
            </div>
        </div>
        <div className='pt-10'>
            <p className='pb-6'>E:</p>
            <a href="./Footer.jsx" className='underline'>hello@ochi.design</a>
        </div>
      </div>
      <div className='flex justify-between items-center pt-5'>
        <div className='flex items-center'>
            <p className='text-zinc-500'>&copy; ochi design 2024.</p>
            <a href="./Footer.jsx" className='underline text-zinc-500 px-1'> Legal Terms</a>
        </div>
        <div>
            <a href="./Footer.jsx" className='text-zinc-500'>Copied by Chirag</a>
        </div>
      </div>
        </div>
      </div>
